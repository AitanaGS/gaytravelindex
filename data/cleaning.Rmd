...
data <- original_data %>%
  ...
  mutate(country = case_when(
   country == "Central African Republic" ~ "Central African Rep.",
    ...
    country == "Virgin Islands" ~ "United States Virgin Islands",
...
### seperate dataset for 2021


```{r}
data2021 <- toJSON(as_tibble(data %>% filter(year == 2021)))
```
...
```{r}
write(data2021, here("processed/GTI_2012-2021_data2021.json"))
```
